 ...
 * 习题微课筛选
 */
public class Screen2Activity extends AppCompatActivity implements View.OnClickListener, OnLoadRegisterListener, AdapterView.OnItemClickListener, OnLoadRegisterListener1, OnLoadRegisterListener2, OnLoadRegisterListener3, OnLoadRegisterListener4{
    ...
    private void initView() {
        mBack = (ImageView) findViewById(R.id.img_screen2);
        mBtn = (Button) findViewById(R.id.btn_screen2);
        // 基础信息
        getJiChu();
    ...
    private void getJiChu() {
        //学段
        mGridView1 = (GridView) findViewById(R.id.gridview_screen2_1);
        mGridView1.setOnItemClickListener(this);
        //年级
        mGridView2 = (GridView) findViewById(R.id.gridview_screen2_2);
        mGridView2.setOnItemClickListener(this);
        //学科
        mGridView3 = (GridView) findViewById(R.id.gridview_screen2_3);
        mGridView3.setOnItemClickListener(this);
        //版本
        mGridView4 = (GridView) findViewById(R.id.gridview_screen2_4);
        mGridView4.setOnItemClickListener(this);
        //模块
        mGridView5 = (GridView) findViewById(R.id.gridview_screen2_5);
    ...
    private void getVolley() {
       ...
       // Log.e("=====", "id1=" + id1);
        //年级
        VolleyUtils.connectionGET1(VideoURL.JICHUFENLEI + "fid=" + id1 + "&level=" + 2, Screen2Activity.this, mQueue);
       ...
       // Log.e("=====", "id2=" + id2);
        //科目
        VolleyUtils.connectionGET2(VideoURL.JICHUFENLEI + "fid=" + id2 + "&level=" + 3, Screen2Activity.this, mQueue);
        ...
        //Log.e("=====", "id2=" + id2);
        //版本
        VolleyUtils.connectionGET3(VideoURL.JICHUFENLEI + "fid=" + id3 + "&level=" + 4, Screen2Activity.this, mQueue);
        ...
        //Log.e("=====", "id4=" + id4);
        //模块
        VolleyUtils.connectionGET4(VideoURL.MOKUAI + "fid=" + id4, Screen2Activity.this, mQueue);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_screen2:
                SharedPreferences preferences3 = this.getSharedPreferences("baby3", Context.MODE_PRIVATE);
                String id4 = preferences3.getString("id4", null);
                SharedPreferences preferences4 = this.getSharedPreferences("baby4", Context.MODE_PRIVATE);
                String id5 = preferences4.getString("id5", null);
               // Log.e("=====", "id4=" + id4 + "id5=" + id5);
                bundle.putString("bbb", "back");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()) {
            //学段
            case R.id.gridview_screen2_1:
                HashMap<String, String> hashMap = mList.get(position);
                String id1 = hashMap.get("id");
               // Log.e("abc", id1 + "");
                SharedPreferences preferences = Screen2Activity.this.getSharedPreferences("baby", Context.MODE_PRIVATE);
                ...
                break;
            //年级
            case R.id.gridview_screen2_2:
                HashMap<String, String> hashMap1 = mList1.get(position);
                String id2 = hashMap1.get("id");
                //Log.e("abc", id2 + "");
                SharedPreferences preferences1 = Screen2Activity.this.getSharedPreferences("baby1", Context.MODE_PRIVATE);
                ...
                break;
            //科目
            case R.id.gridview_screen2_3:
                HashMap<String, String> hashMap2 = mList2.get(position);
                String id3 = hashMap2.get("id");
               // Log.e("abc", "id3=" + id3 + "");
                SharedPreferences preferences2 = Screen2Activity.this.getSharedPreferences("baby2", Context.MODE_PRIVATE);
                ...
                break;
            //版本
            case R.id.gridview_screen2_4:
                HashMap<String, String> hashMap3 = mList3.get(position);
                String id4 = hashMap3.get("id");
               // Log.e("abc", id4 + "");
                SharedPreferences preferences3 = Screen2Activity.this.getSharedPreferences("baby3", Context.MODE_PRIVATE);
                ...
                break;
            //模块
            case R.id.gridview_screen2_5:
                HashMap<String, String> hashMap4 = mList4.get(position);
                String id5 = hashMap4.get("id");
               // Log.e("abc", "模块id5=" + id5 + "");
                SharedPreferences preferences4 = Screen2Activity.this.getSharedPreferences("baby4", Context.MODE_PRIVATE);
