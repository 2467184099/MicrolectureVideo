...
import com.example.administrator.microlecturevideo.main.mvp.activity.weikevideo.fragment.ChargeFragment;
import com.example.administrator.microlecturevideo.main.mvp.activity.weikevideo.fragment.FreeFragment;
import com.example.administrator.microlecturevideo.main.mvp.activity.weikevideo.fragment.MicrolectureFragment;
 ...
 * 微课视频视频详情
 */
public class VideoWebActivity extends AppCompatActivity implements View.OnClickListener, OnLoadRegisterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<ListBean> data = MicrolectureFragment.getData();
        id = data.get(position - 1).getId();
        Log.e("----", "id=" + id);
    ...
    private void getFragment() {
        ...
        FragmentManager fragmentManager = VideoWebActivity.this.getSupportFragmentManager();
        FragmentTransaction transaction = fragmentManager.beginTransaction();
        transaction.replace(R.id.feamelayout_web, new FreeFragment());
        transaction.commit();
    }
    ...
    private void initView() {
        ...
        mTextView_charge.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FragmentManager fragmentManager = VideoWebActivity.this.getSupportFragmentManager();
                        FragmentTransaction transaction = fragmentManager.beginTransaction();
                        transaction.replace(R.id.feamelayout_web, new ChargeFragment());
                        transaction.commit();
                        if (payly == 1 || payly == 0) {
        ...
        mImageView_down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(VideoWebActivity.this, DownActivity.class));
            }
        });
        mLayout_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mTextView_shop.getText().equals("下载")) {
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(VideoWebActivity.this);
                    ...
                    dialog.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            RequestQueue queue = Volley.newRequestQueue(VideoWebActivity.this);
                            VolleyUtils.connectionGET(url, VideoWebActivity.this, queue);
                        }
                    });
    ...
    @Override
    public void onClick(View v) {
        bundle1.putString("aaa", "back");//添加要返回给页面1的数据
