 ...
 * 下载
 */
public class DownActivity extends AppCompatActivity implements View.OnClickListener, OnLoadRegisterListener, XListView.IXListViewListener {
    //回退建
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences shar = this.getSharedPreferences("test", Context.MODE_PRIVATE);
        ...
        xListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               String url1 = urlArr1.replace(".flv", ".mp4");
                Intent intent = new Intent(DownActivity.this, DownLoadActivity.class);
    ...
    public void onLoadMore() {
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                stop();
                Toast.makeText(DownActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
            }
        }, 1000);
    }
